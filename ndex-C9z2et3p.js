...
function wr(e, t, n, r, l) {
    ...
    if (i)
        ...
        wr(l, t, n, "", function(d) {
            return d
        })) : l != null && (Bo(l) && (l = xc(l, n + (!l.key || i && i.key === l.key ? "" : ("" + l.key).replace(Oi, "$&/") + "/") + e)),
        t.push(l)),
        1;
    if (i = 0,
    r = r === "" ? "." : r + ":",
...
function es(e, t, n) {
    ...
    for (r in t)
        jc.call(t, r) && !Lc.hasOwnProperty(r) && (l[r] = t[r]);
    if (e && e.defaultProps)
...
(function(e) {
    ...
    function S(C, j) {
        ...
        try {
            for (f(j),
            m = n(s); m !== null && (!(m.expirationTime > j) || C && !Pe()); ) {
                var W = m.callback;
    ...
    e.unstable_scheduleCallback = function(C, j, z) {
        ...
        z > W ? (C.sortIndex = z,
        t(d, C),
        n(s) === null && C === n(d) && (x ? (c(P),
        P = -1) : x = !0,
        gl(y, z - W))) : (C.sortIndex = X,
        t(s, C),
        k || w || (k = !0,
        yl(S))),
        C
...
var Qe = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , Ai = {};
function Dc(e) {
    return Kl.call(Ai, e) ? !0 : Kl.call(Ii, e) ? !1 : Rc.test(e) ? Ai[e] = !0 : (Ii[e] = !0,
    !1)
}
function Fc(e, t, n, r) {
    if (n !== null && n.type === 0)
...
function ql(e, t) {
    ...
    t.hasOwnProperty("value") ? bl(e, t.type, n) : t.hasOwnProperty("defaultValue") && bl(e, t.type, dt(t.defaultValue)),
...
function nd(e, t) {
    for (var n = e.suspendedLanes, r = e.pingedLanes, l = e.expirationTimes, o = e.pendingLanes; 0 < o; ) {
        var i = 31 - Me(o)
          , u = 1 << i
          , s = l[i];
        s === -1 ? (!(u & n) || u & r) && (l[i] = td(u, t)) : s <= t && (e.expiredLanes |= u),
        o &= ~u
    }
}
function so(e) {
...
var zs, qo, Ls, Ts, Ms, ao = !1, sr = [], rt = null, lt = null, ot = null, Fn = new Map, On = new Map, be = [], ld = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Yi(e, t) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function od(e, t, n, r, l) {
    ...
    case "pointerover":
        var o = l.pointerId;
        return Fn.set(o, pn(Fn.get(o) || null, e, t, n, r, l)),
        !0;
    case "gotpointercapture":
        return o = l.pointerId,
        On.set(o, pn(On.get(o) || null, e, t, n, r, l)),
        !0
    }
    return !1
}
...
function Fs() {
    if (Sr)
        return Sr;
    var e, t = ei, n = t.length, r, l = "value"in tt ? tt.value : tt.textContent, o = l.length;
...
function ke(e) {
    function t(n, r, l, o, i) {
        ...
        for (var u in e)
            ...
            this[u] = n ? n(o) : o[u]);
        return this.isDefaultPrevented = (o.defaultPrevented != null ? o.defaultPrevented : o.returnValue === !1) ? ar : Xi,
...
var Md = Qe && "TextEvent"in window && !Nn
  , Os = Qe && (!ri || Nn && 8 < Nn && 11 >= Nn)
  , bi = " "
  , eu = !1;
function Is(e, t) {
    switch (e) {
...
function Dd(e, t) {
    if (Ot)
        return e === "compositionend" || !ri && Is(e, t) ? (e = Fs(),
        Sr = ei = tt = null,
        Ot = !1,
        e) : null;
    switch (e) {
...
function ru() {
    _n && (_n.detachEvent("onpropertychange", Vs),
    An = _n = null)
}
function Vs(e) {
...
function Ad(e, t, n) {
    ...
    _n = t,
    An = n,
    _n.attachEvent("onpropertychange", Vs)) : e === "focusout" && ru()
}
function Ud(e) {
...
for (var Ml = 0; Ml < uu.length; Ml++) {
    var Rl = uu[Ml]
      , Qd = Rl.toLowerCase()
      , Kd = Rl[0].toUpperCase() + Rl.slice(1);
    pt(Qd, "on" + Kd)
}
...
function $n(e) {
    if (!e[dr]) {
        ...
        ls.forEach(function(n) {
            n !== "selectionchange" && (Yd.has(n) || Dl(n, !1, e),
            Dl(n, !0, e))
        });
    ...
    ks(function() {
        ...
        e: {
            ...
            if (p !== void 0) {
                ...
                for (var a = d, f; a !== null; ) {
                    ...
                    c !== null && (y = Dn(a, c),
                    y != null && x.push(Vn(a, y, f)))),
                    D)
                        break;
                    a = a.return
                }
                0 < x.length && (p = new w(p,k,null,n,h),
                m.push({
                    event: p,
                    listeners: x
                }))
        ...
        if (!(t & 7)) {
            e: {
                ...
                p && n !== lo && (k = n.relatedTarget || n.fromElement) && (xt(k) || k[Ke]))
                    break e;
                ...
                w !== k)) {
                    ...
                    c = "onMouseEnter",
                    a = "mouse",
                    (e === "pointerout" || e === "pointerover") && (x = qi,
                    y = "onPointerLeave",
                    c = "onPointerEnter",
                    a = "pointer"),
                    D = w == null ? p : Ut(w),
                    ...
                    p.relatedTarget = f,
                    y = null,
                    xt(h) === d && (x = new x(c,a + "enter",k,n,h),
                    x.target = f,
                    x.relatedTarget = D,
                    y = x),
                    D = y,
            ...
            switch (N = d ? Ut(d) : window,
            e) {
            case "focusin":
                (tu(N) || N.contentEditable === "true") && (It = N,
                fo = d,
                Pn = null);
                break;
            case "focusout":
            ...
            if (ri)
                ...
                Ot ? Is(e, n) && (P = "onCompositionEnd") : e === "keydown" && n.keyCode === 229 && (P = "onCompositionStart");
            P && (Os && n.locale !== "ko" && (Ot || P !== "onCompositionStart" ? P === "onCompositionEnd" && Ot && (_ = Fs()) : (tt = h,
            ei = "value"in tt ? tt.value : tt.textContent,
            Ot = !0)),
            N = Ar(d, P),
            0 < N.length && (P = new Ji(P,e,null,n,h),
            m.push({
                event: P,
                listeners: N
            }),
            _ ? P.data = _ : (_ = As(n),
            _ !== null && (P.data = _)))),
            (_ = Md ? Rd(e, n) : Dd(e, n)) && (d = Ar(d, "onBeforeInput"),
            0 < d.length && (h = new Ji("onBeforeInput","beforeinput",null,n,h),
            m.push({
                event: h,
                listeners: d
            }),
...
function au(e, t, n, r, l) {
    for (var o = t._reactName, i = []; n !== null && n !== r; ) {
        ...
        u.tag === 5 && d !== null && (u = d,
        l ? (s = Dn(n, o),
        s != null && i.unshift(Vn(n, s, u))) : l || (s = Dn(n, o),
...
var yo = typeof setTimeout == "function" ? setTimeout : void 0
  ...
  , Jd = typeof queueMicrotask == "function" ? queueMicrotask : typeof du < "u" ? function(e) {
...
function qs(e, t, n) {
    ...
    for (var l in r)
        if (!(l in t))
            throw Error(g(108, Ac(e) || "Unknown", l));
    return V({}, n, r)
}
function Vr(e) {
    ...
    if (A) {
        ...
        if (t) {
            ...
            if (!hu(e, t)) {
                ...
                t = it(n.nextSibling);
                var r = ye;
                t && hu(e, t) ? ta(r, n) : (e.flags = e.flags & -4097 | 2,
                A = !1,
                ye = e)
            }
        } else {
...
function pr(e) {
    ...
    e.tag === 13) {
        ...
        ve = ye ? it(e.stateNode.nextSibling) : null;
    return !0
}
function na() {
    for (var e = ve; e; )
...
var nf = Xe.ReactCurrentBatchConfig;
function vn(e, t, n) {
    if (e = n.ref,
...
function ra(e) {
    ...
    function u(c, a, f, y) {
        return a === null || a.tag !== 6 ? (a = Wl(f, c.mode, y),
        a.return = c,
        a) : (a = l(a, f),
        a.return = c,
        a)
    ...
    function s(c, a, f, y) {
        var S = f.type;
        return S === Ft ? h(c, a, f.props.children, y, f.key) : a !== null && (a.elementType === S || typeof S == "object" && S !== null && S.$$typeof === Je && yu(S) === a.type) ? (y = l(a, f.props),
        y.ref = vn(c, a, f),
        y.return = c,
        y) : (y = Lr(f.type, f.key, f.props, null, c.mode, y),
        y.ref = vn(c, a, f),
        y.return = c,
        y)
    }
    function d(c, a, f, y) {
        return a === null || a.tag !== 4 || a.stateNode.containerInfo !== f.containerInfo || a.stateNode.implementation !== f.implementation ? (a = Ql(f, c.mode, y),
        a.return = c,
        a) : (a = l(a, f.children || []),
        a.return = c,
        a)
    }
    function h(c, a, f, y, S) {
        return a === null || a.tag !== 7 ? (a = Nt(f, c.mode, y, S),
        a.return = c,
        a) : (a = l(a, f),
        a.return = c,
        a)
    ...
    function m(c, a, f) {
        if (typeof a == "string" && a !== "" || typeof a == "number")
            return a = Wl("" + a, c.mode, f),
            a.return = c,
            a;
        if (typeof a == "object" && a !== null) {
            switch (a.$$typeof) {
            case rr:
                return f = Lr(a.type, a.key, a.props, null, c.mode, f),
                f.ref = vn(c, null, a),
                f.return = c,
                f;
            case Dt:
                return a = Ql(a, c.mode, f),
                a.return = c,
                a;
            case Je:
                var y = a._init;
                return m(c, y(a._payload), f)
            }
            if (kn(a) || dn(a))
                return a = Nt(a, c.mode, f, null),
                a.return = c,
                a;
            mr(c, a)
        }
    ...
    function p(c, a, f, y) {
        ...
        if (typeof f == "string" && f !== "" || typeof f == "number")
            return S !== null ? null : u(c, a, "" + f, y);
        if (typeof f == "object" && f !== null) {
            switch (f.$$typeof) {
            case rr:
                return f.key === S ? s(c, a, f, y) : null;
            case Dt:
                return f.key === S ? d(c, a, f, y) : null;
            case Je:
                return S = f._init,
                p(c, a, S(f._payload), y)
            }
            if (kn(f) || dn(f))
                return S !== null ? null : h(c, a, f, y, null);
            mr(c, f)
        }
        return null
    }
    function w(c, a, f, y, S) {
        ...
        if (typeof y == "object" && y !== null) {
            switch (y.$$typeof) {
            case rr:
                return c = c.get(y.key === null ? f : y.key) || null,
                s(a, c, y, S);
            case Dt:
                return c = c.get(y.key === null ? f : y.key) || null,
                d(a, c, y, S);
    ...
    function k(c, a, f, y) {
        for (var S = null, N = null, _ = a, P = a = 0, H = null; _ !== null && P < f.length; P++) {
            _.index > P ? (H = _,
            _ = null) : H = _.sibling;
            var T = p(c, _, f[P], y);
            if (T === null) {
    ...
    function x(c, a, f, y) {
        ...
        f == null)
            throw Error(g(151));
        for (var N = S = null, _ = a, P = a = 0, H = null, T = f.next(); _ !== null && !T.done; P++,
        T = f.next()) {
            _.index > P ? (H = _,
            _ = null) : H = _.sibling;
    ...
    function D(c, a, f, y) {
        if (typeof f == "object" && f !== null && f.type === Ft && f.key === null && (f = f.props.children),
        typeof f == "object" && f !== null) {
            switch (f.$$typeof) {
            case rr:
                e: {
                    for (var S = f.key, N = a; N !== null; ) {
                        if (N.key === S) {
                            if (S = f.type,
                            S === Ft) {
                                if (N.tag === 7) {
                            ...
                            } else if (N.elementType === S || typeof S == "object" && S !== null && S.$$typeof === Je && yu(S) === N.type) {
                                n(c, N.sibling),
                                a = l(N, f.props),
                                a.ref = vn(c, N, f),
                                a.return = c,
                    ...
                    f.type === Ft ? (a = Nt(f.props.children, c.mode, y, f.key),
                    a.return = c,
                    c = a) : (y = Lr(f.type, f.key, f.props, null, c.mode, y),
                    y.ref = vn(c, a, f),
                    y.return = c,
                    c = y)
                }
...
function Kr(e, t, n, r) {
    ...
    if (u !== null) {
        ...
        u = h.lastBaseUpdate,
        u !== i && (u === null ? h.firstBaseUpdate = d : u.next = d,
        h.lastBaseUpdate = s))
    }
    if (o !== null) {
        var m = l.baseState;
...
function yi(e, t, n, r, l, o) {
    ...
    t.updateQueue = null,
    t.lanes = 0,
    Nr.current = e === null || e.memoizedState === null ? sf : af,
    e = n(r, l),
    jn) {
        o = 0;
        do {
...
function ka(e, t) {
    ...
    return r !== null && t !== null && vi(t, r[1]) ? r[0] : (n.memoizedState = [e, t],
    e)
}
function xa(e, t) {
    var n = _e();
    t = t === void 0 ? null : t;
    var r = n.memoizedState;
    return r !== null && t !== null && vi(t, r[1]) ? r[0] : (e = e(),
    n.memoizedState = [e, t],
    e)
}
function Sa(e, t, n) {
    return jt & 21 ? (De(n, t) || (n = Ps(),
    $.lanes |= n,
    zt |= n,
    e.baseState = !0),
...
function Pa(e, t, n) {
    var r = !1
      , l = ft
      , o = t.contextType;
    return typeof o == "object" && o !== null ? o = Ne(o) : (l = pe(t) ? _t : le.current,
    r = t.contextTypes,
...
function Co(e, t, n, r) {
    ...
    var o = t.contextType;
    typeof o == "object" && o !== null ? l.context = Ne(o) : (o = pe(t) ? _t : le.current,
    l.context = bt(e, o)),
    l.state = e.memoizedState,
    o = t.getDerivedStateFromProps,
    typeof o == "function" && (Eo(e, t, o, n),
    l.state = e.memoizedState),
...
function ju(e, t, n, r, l) {
    if (e === null) {
        ...
        t.type = o,
        La(e, t, o, r, l)) : (e = Lr(n.type, null, r, t, t.mode, l),
        e.ref = t.ref,
        e.return = t,
        t.child = e)
    }
...
function zu(e, t, n, r, l) {
    ...
    t.stateNode === null)
        ...
        var s = i.context
          , d = n.contextType;
        typeof d == "object" && d !== null ? d = Ne(d) : (d = pe(n) ? _t : le.current,
        d = bt(t, d));
        var h = n.getDerivedStateFromProps
          , m = typeof h == "function" || typeof i.getSnapshotBeforeUpdate == "function";
        m || typeof i.UNSAFE_componentWillReceiveProps != "function" && typeof i.componentWillReceiveProps != "function" || (u !== r || s !== d) && Eu(t, i, r, d),
        qe = !1;
        var p = t.memoizedState;
        i.state = p,
        Kr(t, r, i, l),
        s = t.memoizedState,
        u !== r || p !== s || fe.current || qe ? (typeof h == "function" && (Eo(t, n, h, r),
        s = t.memoizedState),
        (u = qe || Su(t, n, u, r, p, s, d)) ? (m || typeof i.UNSAFE_componentWillMount != "function" && typeof i.componentWillMount != "function" || (typeof i.componentWillMount == "function" && i.componentWillMount(),
        ...
        p = i.context,
        s = n.contextType,
        typeof s == "object" && s !== null ? s = Ne(s) : (s = pe(n) ? _t : le.current,
        s = bt(t, s));
        ...
        u !== m || p !== k || fe.current || qe ? (typeof w == "function" && (Eo(t, n, w, r),
        k = t.memoizedState),
        (d = qe || Su(t, n, d, r, p, k, s) || !1) ? (h || typeof i.UNSAFE_componentWillUpdate != "function" && typeof i.componentWillUpdate != "function" || (typeof i.componentWillUpdate == "function" && i.componentWillUpdate(r, k, s),
        ...
        i.state = k,
        i.context = s,
        r = d) : (typeof i.componentDidUpdate != "function" || u === e.memoizedProps && p === e.memoizedState || (t.flags |= 4),
        typeof i.getSnapshotBeforeUpdate != "function" || u === e.memoizedProps && p === e.memoizedState || (t.flags |= 1024),
        r = !1)
    }
...
function Po(e, t, n, r, l, o) {
    ...
    t.child = tn(t, null, u, o)) : oe(e, t, u, o),
...
function Da(e, t, n) {
    ...
    if (o) {
        ...
        u !== null ? o = ct(u, o) : (o = Nt(o, i, n, null),
        o.flags |= 2),
        o.return = t,
        r.return = t,
        r.sibling = o,
...
function mf(e, t, n) {
    ...
    case 13:
        ...
        r !== null)
            ...
            t.flags |= 128,
            null) : n & t.child.childLanes ? Da(e, t, n) : (F(U, U.current & 1),
            e = Ge(e, t, n),
        ...
        for (d in l)
            if (!r.hasOwnProperty(d) && l.hasOwnProperty(d) && l[d] != null)
                if (d === "style") {
                    ...
                    d !== "dangerouslySetInnerHTML" && d !== "children" && d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && d !== "autoFocus" && (Mn.hasOwnProperty(d) ? o || (o = []) : (o = o || []).push(d, null));
        for (d in r) {
            var s = r[d];
            ...
            r.hasOwnProperty(d) && s !== u && (s != null || u != null))
                if (d === "style")
                    ...
                    u = u ? u.__html : void 0,
                    s != null && u !== s && (o = o || []).push(d, s)) : d === "children" ? typeof s != "string" && typeof s != "number" || (o = o || []).push(d, "" + s) : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && (Mn.hasOwnProperty(d) ? (s != null && d === "onScroll" && O("scroll", e),
                    o || u === s || (o = [])) : (o = o || []).push(d, s))
        }
        n && (o = o || []).push("style", n);
        var d = o;
...
function hf(e, t, n) {
            ...
            pr(t)) {
                ...
                for (var i in o)
                    if (o.hasOwnProperty(i)) {
                        ...
                        l = ["children", "" + u]) : Mn.hasOwnProperty(i) && u != null && i === "onScroll" && O("scroll", r)
                    }
                switch (n) {
                case "input":
                    lr(r),
                ...
                e: {
                    ...
                    for (o in u)
                        if (u.hasOwnProperty(o)) {
                            ...
                            s != null && ps(e, s)) : o === "children" ? typeof s == "string" ? (n !== "textarea" || s !== "") && Rn(e, s) : typeof s == "number" && Rn(e, "" + s) : o !== "suppressContentEditableWarning" && o !== "suppressHydrationWarning" && o !== "autoFocus" && (Mn.hasOwnProperty(o) ? s != null && o === "onScroll" && O("scroll", e) : s != null && Qo(e, o, s, i))
                        }
                    switch (n) {
                    case "input":
                        lr(e),
    ...
    case 13:
        ...
        t.mode & 1 && (e === null || U.current & 1 ? G === 0 && (G = 3) : Pi())),
        ...
        i === null)
            ...
            if (!r)
                ...
                e !== null) {
                    ...
                    2 * Q() - o.renderingStartTime > ln && n !== 1073741824 && (t.flags |= 128,
                    r = !0,
                    yn(o, !1),
                    t.lanes = 4194304);
                        ...
                        case 1:
                            if (k !== null) {
                                var x = k.memoizedProps
                                  , D = k.memoizedState
                                  , c = t.stateNode
                                  , a = c.getSnapshotBeforeUpdate(t.elementType === t.type ? x : ze(t.type, x), D);
            ...
            s !== null)
                try {
                    ...
                    for (i = 0; i < s.length; i += 2) {
                        var h = s[i]
                          , m = s[i + 1];
                        h === "style" ? hs(l, m) : h === "dangerouslySetInnerHTML" ? ps(l, m) : h === "children" ? Rn(l, m) : Qo(l, h, m, d)
                    }
                    switch (u) {
                    case "input":
                        ql(l, o);
...
function at(e) {
    return e.mode & 1 ? M & 2 && b !== 0 ? b & -b : nf.transition !== null ? (zr === 0 && (zr = Ps()),
    zr) : (e = R,
    e !== 0 || (e = window.event,
...
function me(e, t) {
    ...
    e.callbackPriority !== t) {
        if (n != null && Ki(n),
        t === 1)
            e.tag === 0 ? tf(Au.bind(null, e)) : bs(Au.bind(null, e)),
            Jd(function() {
                !(M & 6) && ht()
            }),
            n = null;
...
function Wa(e, t) {
        ...
        if (t === 6)
            ...
            case 3:
                ...
                10 < t)) {
                    ...
                    e.timeoutHandle = yo(kt.bind(null, e, ce, $e), t);
                    break
                }
                kt(e, ce, $e);
                break;
            case 4:
                ...
                10 < r) {
                    e.timeoutHandle = yo(kt.bind(null, e, ce, $e), r);
                    break
                }
                kt(e, ce, $e);
                break;
    ...
    return me(e, Q()),
    e.callbackNode === n ? Wa.bind(null, e) : null
}
function Io(e, t) {
    var n = Ln;
            ...
            e: {
                ...
                do {
                    ...
                    case 1:
                        ...
                        var a = o.type
                          , f = o.stateNode;
                        if (!(o.flags & 128) && (typeof a.getDerivedStateFromError == "function" || f !== null && typeof f.componentDidCatch == "function" && (st === null || !st.has(f)))) {
                            o.flags |= 65536,
                            t &= -t,
                            o.lanes |= t;
                            var y = za(o, u, t);
...
function Nf(e, t, n) {
    ...
    J === e && (b & n) === n && (G === 4 || G === 3 && (b & 130023424) === b && 500 > Q() - Ci ? Ct(e, 0) : Ei |= n),
    me(e, t)
}
function Xa(e, t) {
    t === 0 && (e.mode & 1 ? (t = ur,
...
Za = function(e, t, n) {
    if (e !== null)
        ...
        de = !1,
        A && t.flags & 1048576 && ea(t, Hr, t.index);
    switch (t.lanes = 0,
    t.tag) {
    case 2:
        var r = t.type;
        ...
        e: {
            ...
            o.isDehydrated)
                ...
                t.flags & 256) {
                    ...
                    for (ve = it(t.stateNode.containerInfo.firstChild),
                    ye = t,
                    A = !0,
                    Te = null,
                    n = la(t, null, r, n),
...
var Df = {
  ...
  , Ff = {
    ...
    findFiberByHostInstance: gn.findFiberByHostInstance || Mf,
...
we.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Df;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Af = e => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase().trim()
  , vt = (e, t) => {
    const n = ae.forwardRef( ({color: r="currentColor", size: l=24, strokeWidth: o=2, absoluteStrokeWidth: i, className: u="", children: s, ...d}, h) => ae.createElement("svg", {
        ref: h,
        ...If,
        width: l,
        height: l,
        ...
        ...d
    }, [...t.map( ([m,p]) => ae.createElement(m, p)), ...Array.isArray(s) ? s : [s]]));
...
function Hu({event: e}) {
    const t = Vf[e.category]
      , n = t.icon
      , r = l => new Date(l + "T00:00:00").toLocaleDateString("en-US", {
        month: "short",
        day: "numeric",
        year: "numeric"
    });
    return v.jsx("div", {
        ...
        children: v.jsxs("div", {
            ...
            children: [v.jsx("div", {
                className: `${t.color} p-2 rounded-lg flex-shrink-0`,
                children: v.jsx(n, {
...
function Bf({onSubmit: e, onClose: t}) {
    const [n,r] = ae.useState({
      ...
      , l = o => {
        if (o.preventDefault(),
        !n.name || !n.category || !n.date || !n.location || !n.description) {
    ...
    return v.jsx("div", {
        ...
        children: v.jsxs("div", {
            ...
            children: [v.jsxs("div", {
                className: "sticky top-0 bg-gradient-to-r from-teal-600 to-teal-700 text-white p-4 flex items-center justify-between",
                children: [v.jsx("h2", {
                    className: "text-xl font-bold",
                    children: "Submit a Community Event"
                }), v.jsx("button", {
                    onClick: t,
                ...
                children: [v.jsxs("div", {
                    ...
                    children: [v.jsxs("div", {
                        ...
                        children: [v.jsx("label", {
                            ...
                            placeholder: "E.g., Cumming Town Holiday Market",
                            required: !0
                        })]
                    }), v.jsxs("div", {
                        children: [v.jsx("label", {
...
const Hf = [{
    ...
    description: "One of Atlanta's largest rock & indie festivals — international and local acts across multiple stages.",
    link: "https://www.shakykneesfestival.com",
    featured: !0
}, {
    id: "2",
    name: "Yellow Daisy Festival",
    category: "arts",
    date: "2026-09-04",
    location: "Stone Mountain Park",
    description: "Georgia's hallmark arts & crafts festival with hundreds of artisans, live music, and demonstrations.",
    link: "https://www.yellowdaisyfestival.com",
    featured: !0
}, {
    id: "3",
    name: "Georgia National Fair",
    category: "community",
    date: "2026-10-08",
    location: "Perry, GA",
    description: "State event featuring agriculture, concerts, rides, and community showcases.",
    link: "https://georgianationalfair.com",
    featured: !0
}, {
    id: "4",
    name: "Taste of Suwanee",
    category: "food",
    date: "2025-12-15",
    location: "Suwanee Town Center",
    description: "Local restaurants and food trucks highlight favorite dishes with family entertainment."
}, {
    id: "5",
    name: "Roswell Beer Festival",
    category: "food",
    date: "2026-01-08",
    location: "Roswell, GA",
    description: "Local breweries present craft beers, paired with music and food stalls in historic Roswell."
}, {
    id: "6",
    ...
    date: "2026-01-15",
    location: "Atlanta",
    description: "Community fitness and charity-focused run with local club participation and youth programs."
}, {
    id: "7",
    name: "Blavity Fest",
    category: "community",
    date: "2026-02-02",
    location: "Atlanta",
    description: "Celebration of Black culture, entrepreneurship, and music with panels, showcases, and a marketplace."
}, {
    id: "8",
    name: "Ponce City Market Art Week",
    category: "arts",
    date: "2026-02-14",
    location: "Ponce City Market, Atlanta",
    description: "Workshops, curated pop-up galleries, and artist talks in an adaptive reuse setting."
}, {
    id: "9",
    name: "Brookhaven Cherry Blossom Festival",
    category: "arts",
    date: "2026-02-20",
    location: "Brookhaven",
    description: "Family-friendly celebration with crafts, exhibits, and seasonal performances."
}, {
    id: "10",
    name: "Atlanta Film & Cultural Expo",
    category: "arts",
    date: "2026-03-05",
    location: "Atlanta",
    description: "Independent film showcases and conversations with filmmakers from the region."
}, {
    id: "11",
    name: "ONE Musicfest",
    category: "music",
    ...
    description: "Features national headliners and local artists across hip-hop, R&B, and electronic music."
}, {
    id: "12",
    name: "Summer Sounds Winter Showcase",
    category: "music",
    date: "2026-03-20",
    location: "Centennial Olympic Park",
    description: "Seasonal performance series showcasing local bands and headliners at public park events."
}, {
    id: "13",
    ...
    description: "Volunteer with local Habitat chapters to support affordable housing initiatives."
}, {
    id: "14",
    name: "Acworth Arts & Craft Showcase",
    category: "arts",
    date: "2026-04-09",
    location: "Downtown Acworth",
    description: "Handmade goods, art demonstrations, and family activities in a downtown setting."
}, {
    id: "15",
    name: "DreamHack Atlanta",
    category: "music",
    date: "2026-04-16",
    location: "Atlanta",
    description: "Gaming expo and live entertainment with an esports tournament and music stage."
}, {
    id: "16",
    name: "Blue Ridge Trout & Outdoor Festival",
    category: "sports",
    date: "2026-04-25",
    location: "Blue Ridge",
    description: "Fishing clinics, guided outdoor workshops, and local vendor market in the mountains."
}, {
    id: "17",
    name: "MomoCon",
    category: "arts",
    date: "2026-05-01",
    location: "Atlanta",
    description: "Large fandom convention for anime, gaming and pop culture, with panels and cosplays."
}, {
    id: "18",
    name: "Atlanta Out of the Darkness Walk",
    category: "community",
    date: "2026-05-09",
    location: "Atlanta",
    description: "A community-driven event to raise awareness about mental health and local support services."
}, {
    id: "19",
    name: "Little 5 Fest",
    category: "music",
    ...
    description: "Community music festival with skate demos, local creative vendors, and street performances."
}, {
    id: "20",
    name: "Atlanta First Halal Food Festival",
    category: "food",
    date: "2026-06-05",
    location: "Atlanta",
    description: "Celebration of halal cuisine with diverse vendors and cultural programming."
}];
function Wf() {
    const [e,t] = ae.useState(Hf)
      , [n,r] = ae.useState("")
      , [l,o] = ae.useState("all")
      , [i,u] = ae.useState("")
      , [s,d] = ae.useState("asc")
      ...
      , w = ae.useMemo( () => {
        let c = e.filter(a => {
            const f = l === "all" || a.category === l
              , y = n === "" || a.name.toLowerCase().includes(n.toLowerCase()) || a.location.toLowerCase().includes(n.toLowerCase()) || a.description.toLowerCase().includes(n.toLowerCase())
              , S = i === "" || a.date >= i;
            return f && y && S
        }
        );
        return c.sort( (a, f) => {
            const y = a.date.localeCompare(f.date);
            return s === "asc" ? y : -y
        }
        ),
        c
    ...
    return v.jsxs("div", {
        ...
        children: [v.jsx("header", {
            className: "bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-lg sticky top-0 z-40",
            children: v.jsx("div", {
                ...
                children: v.jsxs("div", {
                    ...
                    children: [v.jsxs("div", {
                        ...
                        children: [v.jsx("div", {
                            className: "w-12 h-12 bg-gradient-to-br from-amber-500 to-teal-600 rounded-lg flex items-center justify-center font-bold text-lg",
                            children: "GA"
                        }), v.jsxs("div", {
                            children: [v.jsx("h1", {
                                className: "text-xl font-bold",
                                children: "Georgia Community Events Hub"
                            }), v.jsx("p", {
                                className: "text-sm text-gray-300",
                                children: "Cumming • Atlanta"
                            })]
                        })]
                    }), v.jsxs("button", {
                        onClick: () => m(!0),
                        className: "bg-teal-600 hover:bg-teal-700 px-4 py-2 rounded-lg font-semibold flex items-center gap-2 transition-colors",
                        children: [v.jsx(Uf, {
                            className: "w-4 h-4"
                        }), "Submit Event"]
                    })]
            ...
            children: [k.length > 0 && v.jsxs("section", {
                className: "mb-10",
                children: [v.jsx("h2", {
                ...
                children: [v.jsxs("div", {
                    ...
                    children: [v.jsx("h2", {
                        ...
                        children: ["Showing ", w.length, " event", w.length !== 1 ? "s" : ""]
                    })]
                }), v.jsxs("div", {
                    ...
                    children: [v.jsxs("div", {
                        ...
                        children: [v.jsxs("div", {
                            ...
                            children: [v.jsxs("select", {
                                ...
                                onClick: D,
                                className: "px-4 py-2 border border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-colors whitespace-nowrap",
                                children: "Clear"
                            })]
                        })]
                    }), v.jsx("div", {
                        ...
                        children: p.map(c => {
                            ...
                            return v.jsxs("button", {
                                onClick: () => o(c.id),
                                className: `px-4 py-2 rounded-full font-semibold text-sm flex items-center gap-2 transition-all ${f ? "bg-gradient-to-r from-teal-600 to-teal-700 text-white shadow-md" : "bg-white border border-gray-300 text-gray-700 hover:border-teal-500 hover:text-teal-600"}`,
                                children: [a && v.jsx(a, {
                                    className: "w-4 h-4"
                                }), c.label]
                            }, c.id)
                ...
                }), w.length > 0 ? v.jsx("div", {
                    className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",
                    children: w.map(c => v.jsx(Hu, {
                        event: c
                    }, c.id))
                }) : v.jsx("div", {
                    ...
                    children: v.jsx("p", {
                        ...
                        children: "No events match your filters. Try clearing filters or changing the date range."
                    })
                })]
            })]
        }), v.jsx("footer", {
            className: "bg-slate-800 text-white py-6 mt-16",
            children: v.jsx("div", {
                ...
                children: v.jsxs("div", {
                    ...
                    children: [v.jsxs("div", {
                        children: [v.jsx("div", {
                            ...
                            children: "Designed for the TSA Webmaster Challenge"
                        })]
                    }), v.jsxs("div", {
...
nc(document.getElementById("root")).render(v.jsx(ae.StrictMode, {
    children: v.jsx(Wf, {})
}));
